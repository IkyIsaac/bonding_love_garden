...
export default async function PackagesPage() {
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl font-bold text-foreground mb-1">Packages</h1>
      <p className="text-sm text-muted-foreground mb-6">Named bundles sold at a fixed price, optionally time-limited.</p>
